defmodule Rumbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    @valid_attrs %{description: "desc", title: "title", url: "https://google.pl"}
    ...
    test "get_video!/1 returns the video given id" do
      owner = user_fixture()
    ...
    test "create_video/2 with valid data creates a video" do
      ...
      assert video.url == "https://google.pl"
    end
    ...
    test "delete_video/2 deletes the video" do
      owner = user_fixture()
      video = video_fixture(owner)
